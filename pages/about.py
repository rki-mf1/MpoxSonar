    ...
    children=[
        ...
        html.Div([
            dbc.Card(
                [
                    dbc.CardImg(src="assets/Prof. Dr. Bernhard Renard.jpeg",
                                top=True, style={"width": "238px", "height": "auto"}, className='align-self-center'),
                    dbc.CardBody(
                        [
                            html.P(
            ...
            dbc.Card(
                [
                    dbc.CardImg(src="assets/Dr. Stephan Fuchs.png", top=True,
                                style={"width": "238px", "height": "auto", 'padding': 'auto'}, className='align-self-center'),
                    dbc.CardBody(
                        [
                            html.P(
                                "Dr. Stephan Fuchs"
                ...
                ], style={"width": "15rem", "margin-right": "5rem", 'display': 'inline-block', 'height': 'auto'},),
            dbc.Card(
                [
                    dbc.CardImg(src="assets/Dr. Anna-Juliane Schmachtenberg.jpeg", top=True,
                                style={"width": "238px", "height": "auto"}, className='align-self-center'),
                    dbc.CardBody(
                        [
                            html.P(
            ...
            dbc.Card(
                [
                    dbc.CardImg(
                        src="assets/Kunaphas Kongkitimanon  .png", top=True, style={"width": "238px", "height": "auto"}, className='align-self-center'),
                    dbc.CardBody(
                        [
                            html.P(
            ...
            dbc.Card(
                [
                    dbc.CardImg(
                        src="assets/Jorge Sanchez-Cortes.png", top=True, style={"width": "238px", "height": "auto"}, className='align-self-center'),
                    dbc.CardBody(
                        [
                            html.P(
        ...
        ], className='dbc_card', style={'text-align': 'center'}),
