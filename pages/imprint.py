...
layout = html.Div(
    children=[
        ...
        html.Br(),
        html.H4(children="Information according to § 5 German Telemedia Act:",
        ...
        html.H4("Contact: "),
        html.Div("Stephan Fuchs", style={"margin-bottom": "10px"}),
        dcc.Link(html.A("fuchss@rki.de"), href="mailto:fuchss@rki.de", target='_blank'),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        html.P(["This page is used to inform website visitors regarding our policies with the collection, use, and disclosure of personal data if anyone decided to use our Service, the MPXRadar website (", dcc.Link(href="https://mpxradar.ddns.net/", target='_blank'),
        ...
        html.P("As a matter of principle, we collect and use personal data of our users only to the extent necessary for providing a functional website and service and as the legal requirements allow."),
        ...
        html.H4("5. Purpose"),
        html.P("The purpose of the MPXRadar service is to provide insights into mutation frequency in public MonkeyPox (mpox) genomes as well as temporal and spatial distributions of genomic mpox variants."),
        html.H4("6. Scope of Data Processing"),
        html.H4("Storage of Browser Data"),
        html.P("Whenever you visit our website, our system automatically collects data and information from the computer system of the calling computer. The following data is collected:"),
        ...
        html.P("This website does not use cookies to collect personally identifiable information about you as a user of the site."),
        html.H4("7. External Links"),
        html.P("Our Service may contain links to other sites. If you click on a third-party link, you will be directed to that site. Note that these external sites are not operated by us. Therefore, we strongly advise you to review the Privacy Policy of these websites. We have no control over, and assume no responsibility for the content, privacy policies, or practices of any third-party sites or services."),
        html.H4("8. Children's Privacy"),
        html.P("Our Services do not address anyone under the age of 18. We do not knowingly collect personal data from children under 13. In the case we discover that a child under 18 has provided us with personal data, we immediately delete this from our servers. If you are a parent or guardian and you are aware that your child has provided us with personal information, please contact us so that we will be able to do necessary actions."),
        html.H4("9. Your Rights"),
        html.P("As a person concerned, you may at any time exercise the rights granted to you by the EU-DSGVO, insofar as they apply to the processing:"),
